...
pub const account_custody = @import("account/custody.zig");
...
pub const principal_manifest_issue = @import("principal/manifest_issue.zig");
pub const principal_issuance = @import("principal/issuance.zig");
...
test {
    ...
    _ = principal_roster;
    _ = principal_manifest_issue;
    _ = principal_issuance;
