//! The Music surface: the human door onto Music — a header, a status line, and its actions, laid out
...
const app = @import("music.zig");

pub const Row = surface.Row;

/// Renders the Music surface into `buffer`.
pub fn render(buffer: []Row) []const Row {
    ...
    return surface.layout("Music", "Ready", &actions, buffer);
}

const testing = std.testing;

test "the music surface renders a header, a status line, and its actions" {
