...
pub const notes_domain = @import("notes/domain.zig");
pub const notes = @import("notes/notes.zig");
pub const notes_surface = @import("notes/surface.zig");
pub const tasks_domain = @import("tasks/domain.zig");
pub const tasks = @import("tasks/tasks.zig");
pub const tasks_surface = @import("tasks/surface.zig");
...
pub const photos_domain = @import("photos/domain.zig");
pub const photos = @import("photos/photos.zig");
pub const photos_surface = @import("photos/surface.zig");
pub const clock_domain = @import("clock/domain.zig");
pub const clock = @import("clock/clock.zig");
pub const clock_surface = @import("clock/surface.zig");
pub const home_domain = @import("home/domain.zig");
pub const home = @import("home/home.zig");
pub const home_surface = @import("home/surface.zig");
pub const keyboard_domain = @import("keyboard/domain.zig");
pub const keyboard = @import("keyboard/keyboard.zig");
pub const keyboard_surface = @import("keyboard/surface.zig");
pub const health_domain = @import("health/domain.zig");
pub const health = @import("health/health.zig");
pub const health_surface = @import("health/surface.zig");
pub const wallet_domain = @import("wallet/domain.zig");
pub const wallet = @import("wallet/wallet.zig");
pub const wallet_surface = @import("wallet/surface.zig");
pub const music_domain = @import("music/domain.zig");
pub const music = @import("music/music.zig");
pub const music_surface = @import("music/surface.zig");
pub const maps_domain = @import("maps/domain.zig");
pub const maps = @import("maps/maps.zig");
pub const maps_surface = @import("maps/surface.zig");
