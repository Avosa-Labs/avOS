...
test "each default app's manifest declares exactly its exported capabilities" {
    ...
    try expectConforms(@import("../notes/manifest.zon"), apps.notes.tools);
    try expectConforms(@import("../tasks/manifest.zon"), apps.tasks.tools);
    try expectConforms(@import("../browser/manifest.zon"), apps.browser.tools);
    try expectConforms(@import("../photos/manifest.zon"), apps.photos.tools);
    try expectConforms(@import("../clock/manifest.zon"), apps.clock.tools);
    try expectConforms(@import("../home/manifest.zon"), apps.home.tools);
    try expectConforms(@import("../keyboard/manifest.zon"), apps.keyboard.tools);
    ...
    try expectConforms(@import("../maps/manifest.zon"), apps.maps.tools);
}
