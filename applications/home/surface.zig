//! The Home surface: the human door onto Home — a header, a status line, and its actions, laid out
...
const app = @import("home.zig");

pub const Row = surface.Row;

/// Renders the Home surface into `buffer`.
pub fn render(buffer: []Row) []const Row {
    ...
    return surface.layout("Home", "Ready", &actions, buffer);
}

const testing = std.testing;

test "the home surface renders a header, a status line, and its actions" {
