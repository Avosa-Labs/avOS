//! The Photos surface: the human door onto Photos — a header, a status line, and its actions, laid out
...
const app = @import("photos.zig");

pub const Row = surface.Row;

/// Renders the Photos surface into `buffer`.
pub fn render(buffer: []Row) []const Row {
    ...
    return surface.layout("Photos", "Ready", &actions, buffer);
}

const testing = std.testing;

test "the photos surface renders a header, a status line, and its actions" {
